...
#include <memory>
#include "../Tic-Tac-Toe-master/widgets/BoardWidget.h"
...
QT_MOC_LITERAL(1, 12, 12), // "boardClicked"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4), // "Cell"
QT_MOC_LITERAL(4, 31, 4) // "cell"

    },
    "BoardWidget\0boardClicked\0\0Cell\0cell"
};
...
void BoardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->boardClicked((*reinterpret_cast< Cell(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BoardWidget::*)(Cell );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BoardWidget::boardClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BoardWidget::boardClicked(Cell _t1)
{
