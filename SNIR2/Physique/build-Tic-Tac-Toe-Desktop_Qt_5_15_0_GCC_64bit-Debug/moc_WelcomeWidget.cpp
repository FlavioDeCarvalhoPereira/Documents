...
#include <memory>
#include "../Tic-Tac-Toe-master/widgets/WelcomeWidget.h"
...
QT_MOC_LITERAL(1, 14, 19), // "clickedSinglePlayer"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 18), // "clickedMultiPlayer"
QT_MOC_LITERAL(4, 54, 29), // "on_buttonSinglePlayer_clicked"
QT_MOC_LITERAL(5, 84, 28) // "on_buttonMultiPlayer_clicked"

    },
    "WelcomeWidget\0clickedSinglePlayer\0\0"
    "clickedMultiPlayer\0on_buttonSinglePlayer_clicked\0"
    "on_buttonMultiPlayer_clicked"
};
...
void WelcomeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clickedSinglePlayer(); break;
        case 1: _t->clickedMultiPlayer(); break;
        case 2: _t->on_buttonSinglePlayer_clicked(); break;
        case 3: _t->on_buttonMultiPlayer_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomeWidget::clickedSinglePlayer)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WelcomeWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomeWidget::clickedMultiPlayer)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void WelcomeWidget::clickedSinglePlayer()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void WelcomeWidget::clickedMultiPlayer()
{
