...
BarreRonde::BarreRonde(string _ref,string _nom,const float _mVolumique , const float _taille ,const float _diametre):
...
void BarreRonde::AfficherCaracteristiques()
{
    ...
    cout << "Masse de la barre : " << BarreRonde::CalculerMasse() << "Kg" <<  endl;
    cout << endl;
}
